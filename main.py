...
date_label = ttk.Label(window, text="Date début:")
date_label.grid(row=3, column=0, padx=10, pady=10, sticky="w")
start_date_entry = Calendar(window)
...
end_label.grid(row=4, column=0, padx=10, pady=10, sticky="w")
end_date_entry = Calendar(window)
...
seuil_label.grid(row=5, column=0, padx=10, pady=10, sticky="w")
seuil_entry = ttk.Entry(window)
seuil_entry.grid(row=5, column=1, padx=10, pady=10, sticky="w")

# Label and Entry for Montant plafond
montant_label = ttk.Label(window, text="Montant plafond:")
montant_label.grid(row=6, column=0, padx=10, pady=10, sticky="w")
montant_entry = ttk.Entry(window)
montant_entry.grid(row=6, column=1, padx=10, pady=10, sticky="w")

# Create a button to print the selected file paths
#print_button = ttk.Button(window, text="Print File Paths", command=print_selected_file_paths)
#print_button.grid(row=7, column=0, columnspan=3, pady=10)
...
start_button.grid(row=7, column=0, columnspan=3, pady=10, padx=10, sticky="we")

# Create a progress bar
progress_bar = ttk.Progressbar(window, orient="horizontal", length=200, mode="determinate", takefocus=True, maximum=100)
progress_bar.grid(row=8, column=0, columnspan=3, pady=10, padx=10, sticky="we")

# Add a label to display the percentage
progress_label = ttk.Label(window, text="0%")
progress_label.grid(row=9, column=0, columnspan=3, pady=10, padx=10, sticky="we")
